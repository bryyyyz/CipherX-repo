...
class _CaesarScreenState extends State<CaesarScreen> {
  ...
  int _parseShift() {
    return int.tryParse(_shiftController.text) ?? 0;
  }

  @override
  Widget build(BuildContext context) {
    final String output = CipherLogic.caesar(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Shift letters to encrypt or decode',
                                      style: TextStyle(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    _ModernIconButton(
                                      ...
                                      color: accentColor,
                                      onPressed: () {
                                        final int v = _parseShift() - 1;
                                        _shiftController.text = v.toString();
                                        setState(() {});
                                      },
                                    ),
                                    Container(
